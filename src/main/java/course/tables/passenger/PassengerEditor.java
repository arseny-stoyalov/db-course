...
public class PassengerEditor extends VerticalLayout implements KeyNotifier {
    ...
    TextField seatId = new TextField("Код места");
    ...
    public PassengerEditor(PassengerRepository repository) {
        ...
        add(name, surname, seatId, phoneNumber, payed, actions);

        binder.bind(seatId, p -> p.getSeatId() + "", (p, v) -> p.setSeatId(Integer.parseInt(v)));
